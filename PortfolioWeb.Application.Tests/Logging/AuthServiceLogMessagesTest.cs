...
public class AuthServiceLogMessagesTest
{
    [Test]
    public void AuthServiceLogMessages_ShouldLogForEveryDeclaredMethod_WhenLoggingIsEnabled()
    {
        var loggerType = typeof(AuthService).Assembly.GetType(
            "PortfolioWeb.Application.Logging.AuthServiceLogMessages",
            throwOnError: true)!;
