...
public class AuthorServiceLogMessagesTest
{
    [Test]
    public void AuthorServiceLogMessages_ShouldLogForEveryDeclaredMethod_WhenLoggingIsEnabled()
    {
        var loggerType = typeof(AuthorService).Assembly.GetType(
            "PortfolioWeb.Application.Logging.AuthorServiceLogMessages",
            throwOnError: true)!;
