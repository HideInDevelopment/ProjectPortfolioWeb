...
internal static partial class ProjectServiceLogMessages
{
    ...
    [LoggerMessage(EventId = 2006, Level = LogLevel.Information, Message = "Project created successfully. ProjectId: {ProjectId}, AuthorId: {AuthorId}")]
    public static partial void ProjectCreatedSuccessfully(this ILogger logger, Guid projectId, Guid authorId);

    [LoggerMessage(EventId = 2007, Level = LogLevel.Warning, Message = "Project update rejected because the provided project id is empty.")]
    public static partial void ProjectUpdateRejectedBecauseIdIsEmpty(this ILogger logger);

    [LoggerMessage(EventId = 2008, Level = LogLevel.Information, Message = "Updating project. ProjectId: {ProjectId}, Title: {Title}, Version: {Version}")]
    public static partial void UpdatingProject(this ILogger logger, Guid projectId, string title, int version);

    [LoggerMessage(EventId = 2009, Level = LogLevel.Warning, Message = "Project not found during update. ProjectId: {ProjectId}")]
    public static partial void ProjectNotFoundDuringUpdate(this ILogger logger, Guid projectId);

    [LoggerMessage(EventId = 2010, Level = LogLevel.Warning, Message = "Project not found during update persistence. ProjectId: {ProjectId}")]
    public static partial void ProjectNotFoundDuringUpdatePersistence(this ILogger logger, Guid projectId);

    [LoggerMessage(EventId = 2011, Level = LogLevel.Information, Message = "Project updated successfully. ProjectId: {ProjectId}")]
    public static partial void ProjectUpdatedSuccessfully(this ILogger logger, Guid projectId);

    [LoggerMessage(EventId = 2012, Level = LogLevel.Warning, Message = "Project deletion rejected because the provided project id is empty.")]
    public static partial void ProjectDeletionRejectedBecauseIdIsEmpty(this ILogger logger);

    [LoggerMessage(EventId = 2013, Level = LogLevel.Information, Message = "Deleting project. ProjectId: {ProjectId}")]
    public static partial void DeletingProject(this ILogger logger, Guid projectId);

    [LoggerMessage(EventId = 2014, Level = LogLevel.Warning, Message = "Project not found during deletion. ProjectId: {ProjectId}")]
    public static partial void ProjectNotFoundDuringDeletion(this ILogger logger, Guid projectId);

    [LoggerMessage(EventId = 2015, Level = LogLevel.Information, Message = "Project deleted successfully. ProjectId: {ProjectId}")]
